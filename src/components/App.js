...
const LeftPanel = (props, context) => (<Panel left="left" reveal="reveal" layout="dark">
...
const RightPanel = (props, context) => (<Panel right="right" cover="cover" layout="dark">
    <View id="right-panel-view" navbarThrough="navbarThrough" dynamicNavbar={true}>
        {
            context.framework7AppContext.theme.ios
                ? <Navbar title="Right Panel" sliding="sliding"/>
                : null
        }
        <Pages>
            <Page>
...
const AppLoginScreen = () => (<LoginScreen id="login-screen">
    <View>
        <Pages>
